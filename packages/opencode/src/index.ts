...
if (OpenCodezIdentity.enabled) {
  cli.command(OpenCodezUpgradeCommand).command(OpenCodezUninstallCommand).command(OpenCodezUpdateCommand)
} else {
  cli.command(UpgradeCommand).command(UninstallCommand)
}
