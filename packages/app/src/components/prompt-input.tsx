...
import { createOpenCodezPromptControl } from "./opencodez-prompt-control"
...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  const openCodezPrompt = createOpenCodezPromptControl({
    sessionID: () => props.controls.session.id,
    sessionMetadata: () => info()?.metadata,
    model: () => {
  ...
  const OpenCodezPromptControl = openCodezPrompt.Control
  ...
  const { abort, handleSubmit } =
    ...
    createPromptSubmit({
      ...
      metadata: openCodezPrompt.metadata,
